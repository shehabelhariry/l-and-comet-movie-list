...
export default class MovieFilter extends React.Component {
  ...
  handleInputChange (e) {
    ...
    axios.get(`https://api.themoviedb.org/3/search/movie?api_key=62c6ce483c7a22d21edca90a14f3853c&language=en-US&genre=35&query=${e.target.value}&page=1&include_adult=false`).then(resp => {
      this.setState({
    ...
    return (
      <div className="movie-filter" onChange={this.handleSelectChange}>
        ...
        <div className="filter__search-field--container">
          <input type="text" className="filter__search-field" onChange={this.handleInputChange} placeholder="Search for movies"/>
          {
            ...
            <div className="filter__search-results">
            {
              ...
              return (
                <div className="search-result__item">
                  <img className="search-result__item__image" src={`https://image.tmdb.org/t/p/w600_and_h900_bestv2/${item.poster_path}`} alt="movie poster"/>
